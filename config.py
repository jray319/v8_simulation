...
#D8_ARGS += ['--sticky-ic-runtime-vm-state', '--log-lazy']
V8_SNAPSHOT_LOG = os.path.join(local_config.V8_ROOT, 'out/ia32.release/obj.target/v8_snapshot/geni/snapshot.log')
V8_TICK_PROCESSOR = os.path.join(local_config.V8_ROOT, 'tools/linux-tick-processor')
# PIN
