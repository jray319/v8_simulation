...
V8_ROOT = os.path.join('/Users/jihochoi/Workspace/v8_jiho/')
...
# PIN
PIN = '/home/jchoi42/pin-2.12-53271-gcc.4.4.7-ia32_intel64-linux/pin'
PIN_ARGS = ['-limit_code_cache', '268435456']
PINTOOL = '/home/jchoi42/Workspace/icount_check_insts.so'
